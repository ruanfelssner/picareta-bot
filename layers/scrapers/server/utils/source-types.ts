import type { VehicleAuctionStatus, VehicleConditionalStatus, VehicleSaleStatus, VehicleSource } from '#shared/types/vehicle'
...
export interface RawScrapedVehicle {
  ...
  conditionalStatus?: VehicleConditionalStatus | null
